...
function QTAssessment() {
  const steps = [
    ...
    },
    {
      ...
      subPoints: [
        "Potassium <4; Magnesium <2 (replete and repeat ECG after 24 hours)",
        "QT-prolonging medication (stop or reduce dose as feasible)",
      ],
      nextStep: null,
    },
    {
      ...
      subPoints: [
        {
          options: [
            <span>
              <a
                href="https://www.mdcalc.com/calc/48/corrected-qt-interval-qtc"
                target="_blank"
                rel="noopener noreferrer"
              >
            ...
            <div className="button-container">
              {currentStep > 0 && (
                <div className="back-button-container">
                  ...
                  <span
                    className="button-text back-text"
              ...
              {currentStep < steps.length - 1 && (
                <div className="next-button-container">
                  <span
                    className="button-text next-text"
